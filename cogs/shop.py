...
class shop(commands.Cog):
    ...
    async def shop(self, ctx, argument=None):
        ...
        if(argument==None):
            embed = discord.Embed(
                ...
                color=0xff0000)
            embed.add_field(name="<:PixelGun:806977756277375027> Gun", value='1000 Scuffed Coins', inline=False)
            ...
            embed = discord.Embed(
                title="<:PixelGun:806977756277375027> Gun",
