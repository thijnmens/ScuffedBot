...
class helpClient(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(
            name=">user remove",
            value="Removes your info from the database",
            inline=False)
        embed.add_field(
    ...
    async def update(self, ctx):
        embed = discord.Embed(
            ...
            description="These are the valid fields for >user update [field] <arg>",
            color=0xff0000)
        embed.add_field(
            name="username <arg>",
            ...
            inline=False)
        embed.add_field(
            name="scoresaber/steam/twitch/youtube/twitter/reddit <arg>",
