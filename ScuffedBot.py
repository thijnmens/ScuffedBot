...
cwd = os.getcwd()
funniList = ["Join the NOPE clan", "Aso kinda cute 😳", "I'm wowking vewy hawd!! uwu", "Grinding PP", "Doin' ur mom", "Scuffed code goes brrr", "Do >NOPE", "Hi cutie owo", "Scuffed Saber","Scuffed Walls"]
